...
<div class="row">
    ...
    <%-- 전화번호로 아이디 찾기 폼 --%>
    <div class="col-6">
        <form id="findUserIdByPhoneForm" action="/auth/find-user-id" method="post" enctype="multipart/form-data">
            <div class="card mb-3">
    ...
    <%-- 이메일로 아이디 찾기 폼 --%>
    <div class="col-6">
        <form id="findUserIdByEmailForm" action="/auth/find-user-id" method="post" enctype="multipart/form-data">
            <div class="card mb-3">
                <div class="card-header">
                    이메일로 아이디 찾기
                </div>
